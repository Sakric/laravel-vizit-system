...
<div class="h-screen flex">
        ...
        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="py-6 px-6 lg:px-8">
                    <h3 id="form-label" class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Sukurti naują puslapį</h3>
    ...
    <div id="main" class="w-full overflow-auto bg-gray-100 h-screen p-10">
        <h1 class="font-bold text-3xl">Puslapiai</h1>
            ...
            <table id="myTable" class="w-full text-sm text-left text-gray-500 dark:text-gray-400 mt-4">
                ...
                @foreach($pages as $page)
                    <tr class="border-b dark:bg-gray-800 dark:border-gray-700 odd:bg-white even:bg-gray-50 odd:dark:bg-gray-800 even:dark:bg-gray-700">
                        <th scope="row"
                            class="px-6 py-4 font-medium text-gray-900 dark:text-white whitespace-nowrap">{{$page->id}}</th>
                        <td id="name-{{$page->id}}" class="px-6 py-4">
                            {{$page->name}}
                        </td>
                        <td  class="px-6 py-4">
                            <img src="/storage/{{$page->thumbnail }}" alt="{{$page->name}}" width="100" height="100"/>
                        </td>
                        <td class="px-6 py-4">
                            <a type="button" data-type="edit" href="/dashboard/post/edit/{{$page->id}}"
                               data-id="{{$page->id}}"
    ...
    container.onclick = function (event) {
        ...
        if (element.nodeName === 'A') {
            if (element.dataset.type === 'delete') {
                ...
                deleteForm.action = `/dashboard/pages/delete/${id}`;
