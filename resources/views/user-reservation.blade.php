...
<div class="w-full h-72 bg-gradient-to-r from-[#40AACA] to-[#35BCA3] flex items-center justify-center">
    <h1 class="text-white text-5xl -mt-28">{{$reservation->doctor->user->name}} {{$reservation->doctor->user->lastname}} {{substr($reservation->date, 0,11)}} {{substr($reservation->date, 11,-3)}}</h1>
</div>


<div class="container sm:w-[600px] md:w-[900px] w-[400px] mx-auto -mt-28 px-28 py-5 bg-white rounded-lg shadow-md">
    <div class="flex flex-col mt-5">
        <h1 class="mt-1 text-3xl font-semibold text-[#35BCA3] mx-auto">Rezervacijos informacija</h1>
