...
<div class="container sm:w-[600px] md:w-[900px] w-[450px] mx-auto -mt-28 px-10 py-5 bg-white rounded-lg shadow-md">
    ...
    <h1 class="mt-1 mb-5 text-3xl font-semibold text-[#35BCA3]">Vizitas</h1>
    </div>
    <div class="flex flex-col gap-[1px] mb-5">
        <div class="w-full bg-gradient-to-r from-[#40AACA] to-[#35BCA3] rounded-md p-5">
            <div class="flex-col">
                <p class="text-3xl mb-1 text-white font-semibold">Paciento informacija</p>
                <p class="text-1xl text-white font-semibold">Vardas: {{$reservation->user->name}}</p>
