...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            ...
            /*}*/
            header {
                background-image: linear-gradient(0deg, rgba(0, 0, 0, 0.3),  rgba(0, 0, 0, 0.3)), url('../public/img/header.jpg');
    ...
    <div class="flex bg-white h-96">
        <div class="flex flex-col w-1/2 p-20 gap-3">
            <h1 class="text-2xl">Apie vizito sistema</h1>
            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
        <div class="w-1/2 flex items-center justify-center  ">
            <img src="img/test.jpg" class="w-2/4" >
        </div>
    </div>
